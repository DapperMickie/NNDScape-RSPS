...
public class ClientConstants {
	 ...
	 */
	public final static String CLIENT_NAME = "NNDScape";
	 ...
	 */
	public final static String[] SERVER_IPS = { "127.0.0.1" };
	 ...
	 */
	public final static String ANNOUNCEMENT = "Welcome to "+ CLIENT_NAME +"!";
