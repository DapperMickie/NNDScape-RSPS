...
public class Client extends ClientEngine {
	...
	static {
		try {
			//BACKGROUND = new Sprite(new URL("http://localhost:12389/6.png"));
			//LOADING_BAR_EMPTY = new Sprite(new URL("http://localhost:12389/frame.png"));
			//LOADING_BAR_FULL = new Sprite(new URL("http://localhost:12389/fullbar.png"));
		} catch (Exception e) {
